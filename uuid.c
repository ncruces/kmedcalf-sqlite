...
*/
/*
** Modified by Keith Medcalf with the following changes
**
** new function uuidblob()   returns new uuid as blob
** new function uuidstring() returns new uuid as string
**
...
int sqlite3_uuid_init(
    ...
    rc += sqlite3_create_function(db, "uuid", 0, SQLITE_UTF8|SQLITE_INNOCUOUS, 0, sqlite3UuidFunc, 0, 0);
    rc += sqlite3_create_function(db, "uuidString", 0, SQLITE_UTF8|SQLITE_INNOCUOUS, 0, sqlite3UuidFunc, 0, 0);
    rc += sqlite3_create_function(db, "uuidBlob", 0, SQLITE_UTF8|SQLITE_INNOCUOUS, (void*)1, sqlite3UuidFunc, 0, 0);
    rc += sqlite3_create_function(db, "uuid_str", 1, SQLITE_UTF8|SQLITE_INNOCUOUS|SQLITE_DETERMINISTIC, 0, sqlite3UuidStrFunc, 0, 0);
    rc += sqlite3_create_function(db, "uuid_blob", 1, SQLITE_UTF8|SQLITE_INNOCUOUS|SQLITE_DETERMINISTIC, 0, sqlite3UuidBlobFunc, 0, 0);
